...
from src.baselines.win_loss import build_team_ratings
...
def run_season(
    ...
    """
    Run the complete baseline pipeline for one season.

    The baseline consists of:

    1. Win-loss team ratings.
...
def run_all_seasons() -> pd.DataFrame:
    """
    Run the baseline pipeline for every evaluable season.
...
def summarize_results(
    ...
    """
    Calculate overall baseline results across all evaluated seasons.
